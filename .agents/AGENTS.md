...
[VALIDATE]
Run the validate CLI: `npx tsx .agents/tools/validate/cli.ts`
- The validate CLI is blocking and self-coordinating via single-flight
— all gates (lint, typecheck, build, test) must pass without warnings or errors
