...
describe('useSessionIntrospection - Fixed Tests', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.clearAllTimers()
    vi.useFakeTimers()
  ...
  describe('✅ Data Fetching', () => {
    it('should fetch data successfully', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('/api/sessions/test-session-123/introspect', expectedFetchOptions)
    })
    ...
    it('should support event type filtering', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        '/api/sessions/test-session-123/introspect?types=SubagentComplete,UserPromptSubmit', 
  ...
  describe('✅ Reactive Updates', () => {
    ...
    it('should update data when event types change', async () => {
      ...
      // Manual refetch required since watchers have immediate: false
      await fetchData()
      expect(mockFetch).toHaveBeenCalledWith('/api/sessions/test-session-123/introspect?types=UserPromptSubmit', expectedFetchOptions)
    })
  })
  ...
  describe('✅ Error Handling', () => {
    it('should handle network errors with retries', async () => {
      ...
      // Fast forward timers to handle retry delays
